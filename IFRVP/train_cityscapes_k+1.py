...
def train(args, ddp_model):
    ...
    dataset_train = Vimeo90K_Train_Dataset(dataset_dir='/dpl/Cityscapes_DMVFN2_triplet_t+1', augment=True)
    ...
    #dataset_val = Vimeo90K_Test_Dataset(dataset_dir='/dpl/IFRNet/vimeo_triplet')
    #dataloader_val = DataLoader(dataset_val, batch_size=16, num_workers=16, pin_memory=True, shuffle=False, drop_last=True)

    optimizer = optim.RAdam(ddp_model.parameters(), lr=args.lr_start, weight_decay=0)
    ...
    for epoch in range(args.resume_epoch, args.epochs):
        ...
        for i, data in enumerate(dataloader_train):
            ...
            #the one line below is for prediction training
...
if __name__ == '__main__':
    ...
    elif args.model_name == 'IFRNet_T':
        from models.IFRNet_T import Model
    elif args.model_name == 'IFRNet_ELAN':
        from models.IFRNet_ELAN import Model   
