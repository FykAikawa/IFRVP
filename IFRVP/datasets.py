...
class Vimeo90K_Train_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.augment == True:
            img0, imgt, img1 = random_resize(img0, imgt, img1, p=0.1)
            img0, imgt, img1 = random_crop(img0, imgt, img1, crop_size=(256, 256))
            ...
            img0, imgt, img1 = random_reverse_time(img0, imgt, img1, p=0.)
